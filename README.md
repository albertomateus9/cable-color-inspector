...
Traditional computer vision utility for counting cable and fiber color groups in an uploaded image.

## Overview

Cable Color Inspector is a browser-first MVP for the GitHub portfolio of Alberto Mateus P. da Gama. It is built to demonstrate low-cost computer vision applied to telecommunications, infrastructure operations, and technical education.
...
Cable Color Inspector e um MVP browser-first para o portfolio GitHub de Alberto Mateus P. da Gama. O projeto demonstra visao computacional de baixo custo aplicada a telecomunicacoes, operacoes de infraestrutura e educacao tecnica.
