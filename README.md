# Inspetor De Cores De Cabos E Fibras

Ferramenta de visao tradicional para contar grupos de cores de patch cords e fibras em amostras locais.

**Demo:** https://albertomateus9.github.io/cable-color-inspector/

## Visão Geral

Inspetor De Cores De Cabos E Fibras é uma ferramenta de portfólio em Telecom + IA + Visão Computacional. O MVP foi mantido simples, executável e seguro para evoluções futuras sem depender de backend.
